...
import type { createCaptcha } from "../server";
...
export interface CustomCaptchaProps {
     ...
     */
    refreshCaptcha: () => Promise<Awaited<ReturnType<typeof createCaptcha>> | { error: string; } | undefined | null>;
    ...
    return (
        <div className="relative">
            <div className="flex space-x-2 items-center">
                ...
                />
                <label htmlFor="custom-captcha-w3s435q" className="text-sm font-medium">
